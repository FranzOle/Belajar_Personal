...
class Task extends JPanel {
    ...
    Task() {
        ...
        taskName = new JTextField("Buat Catatanmu..."); // create task name text field
...
class Footer extends JPanel {
    ...
    Footer() {
        ...
        addTask = new JButton("Tambah Catatan"); 
        ...
        clear = new JButton("Hapus Catatan yang selesai "); // clear button
...
class AppFrame extends JFrame {
    ...
    public void addListeners() {
        ...
        clear.addMouseListener(new MouseAdapter() {
            @override
            public void mousePressed(MouseEvent e) {
                list.removeCompletedTasks(); // Remove
