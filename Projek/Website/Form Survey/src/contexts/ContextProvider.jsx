...
const tmpSurveys = [
    {
        "id": 1,
        "image_url": "https://i.ibb.co/7pCrh2G/dotnet.jpg",
        "title": ".Net",
        "slug": "thecodeholic-youtube-channel",
        "status": true,
        "description": ".NET is a secure, reliable, and high-performance application platform. C# is the programming language for .NET. It's strongly-typed and type-safe and has integrated concurrency and automatic memory management.",
            ...
            "data": {
              "options": [
                ...
                },
                {
                  ...
                  "text": "Everything Lionel thinks will be good"
                }
              ]
            }
          },
    ...
    {
        "id": 2,
        "image_url": "https://i.ibb.co/XD3Wp3H/react.jpg",
        "title": "React",
        "slug": "react",
        "status": true,
    ...
    {
    "id": 3,
    "image_url": "https://i.ibb.co/sF7MBfy/laravelpng.jpg",
    "title": "Laravel 9",
    "slug": "laravel-9",
    "status": true,
